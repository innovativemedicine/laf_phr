...
//        resource url: [ plugin: 'laf', dir: 'bootstrap-3.1.1/css', file: 'bootstrap.min.css' ], attrs:[ rel: "stylesheet", type:'css' ], bundle: 'bundle_laf'
...
//        resource url:'bootstrap-3.1.1/js/bootstrap.min.js'
